...
def call_bundesliga_games_ml_predictions():
...
print("Script Bundesliga game ml predictions running")

# Set the Eastern Time (EST) timezone
est = pytz.timezone('US/Eastern')

# Schedule the script to run every day at 2 PM EST
schedule.every().day.at("14:00").do(call_bundesliga_games_ml_predictions).timezone = est
