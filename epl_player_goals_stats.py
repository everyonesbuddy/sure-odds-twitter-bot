...
# Authenticate with Twitter API
    ...
    for game in odds_data[:3]:
        ...
        if home_epl_players_goals_stats:
            tweet_text = (
                f"🚨{home_team} Player ({home_epl_players_goals_stats['player']}) Goals:"
                f"\n Last Game: {home_epl_players_goals_stats['goalsLastGame']},"
                f"\n 2 Games Ago: {home_epl_players_goals_stats['goalsTwoGamesAgo']},"
                f"\n 3 Games Ago: {home_epl_players_goals_stats['goalsThreeGamesAgo']},"
                f"\n 4 Games Ago: {home_epl_players_goals_stats['goalsFourGamesAgo']},"
                f"\n 5 Games Ago: {home_epl_players_goals_stats['goalsFiveGamesAgo']},"
                f"\n Avg Last 3 Games: {home_epl_players_goals_stats['avergeLastThree']}"
                f"\n Szn Avg: {home_epl_players_goals_stats['goalsPerGameCurrentSeason']}"
        ...
        if away_epl_players_goals_stats:
            tweet_text = (
                f"🚨{away_team} Player ({away_epl_players_goals_stats['player']}) Goals:"
                f"\n Last Game: {away_epl_players_goals_stats['goalsLastGame']},"
                f"\n 2 Games Ago: {away_epl_players_goals_stats['goalsTwoGamesAgo']},"
                f"\n 3 Games Ago: {away_epl_players_goals_stats['goalsThreeGamesAgo']},"
                f"\n 4 Games Ago: {away_epl_players_goals_stats['goalsFourGamesAgo']},"
                f"\n 5 Games Ago: {away_epl_players_goals_stats['goalsFiveGamesAgo']},"
                f"\n Avg Last 3 Games: {away_epl_players_goals_stats['avergeLastThree']}"
                f"\n Szn Avg: {away_epl_players_goals_stats['goalsPerGameCurrentSeason']}"
...
schedule.every().day.at("09:00").do(epl_player_goals_stats).timezone = est
