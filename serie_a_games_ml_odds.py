...
def call_serie_a_games_ml_odds():
...
print("Script Serie A game ml odds running")

#  Set the Eastern Time (EST) timezone
est = pytz.timezone('US/Eastern')

# Schedule the script to run every day at 12 PM EST
schedule.every().day.at("12:00").do(call_serie_a_games_ml_odds).timezone = est
