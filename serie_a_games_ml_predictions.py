...
def call_serie_a_games_ml_predictions():
    ...
    serie_a_games_and_odds_api_url = "https://api.the-odds-api.com/v4/sports/soccer_italy_serie_a/odds/?apiKey=5e7c521ab26381b068424419c586233a&regions=us&markets=h2h&oddsFormat=american&bookmakers=fanduel"

    # Make a request to the API
    response = requests.get(serie_a_games_and_odds_api_url)
...
print("Script Serie A game ml predictions running")

#  Set the Eastern Time (EST) timezone
est = pytz.timezone('US/Eastern')

# Schedule the script to run every day at 12 PM EST
schedule.every().day.at("12:00").do(call_serie_a_games_ml_predictions).timezone = est
